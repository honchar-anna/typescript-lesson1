const inputWord = document.querySelector('.writ-word')as HTMLInputElement;
const btnAdd = document.querySelector('.add')as HTMLInputElement;
const btnRESET = document.querySelector('.reset')as HTMLInputElement;
const text = document.querySelector('textarea')as HTMLTextAreaElement;
const btnCENZOR = document.querySelector('.cenzor-btn')as HTMLInputElement;
const badWord =  document.querySelector('.red-w')as HTMLElement;
const such = document.querySelector('.err-input') as HTMLElement;
...
else{text.placeholder = "Please write a text!";
